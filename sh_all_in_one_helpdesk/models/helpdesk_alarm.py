                            ...
                            if deadline_date and deadline_date != False:
                                if alarm.type == 'popup':
                                    ...
                                    if fields.Date.today() == deadline_date.date() and deadline_date.hour == now.hour and deadline_date.minute == now.minute:
                                        ...
                                        partners=[]
                                        if ticket.team_head and ticket.team_head.partner_id.id not in partners:
                                            # if ticket.team_head.partner_id.id not in partners:
                                            partners.append(ticket.team_head.partner_id.id)
                                        if ticket.user_id and ticket.user_id.partner_id.id not in partners:
                                        ...
                                        if len(partners) > 0:
                                            for partner_id in partners:
                                                ...
                                                # notification_data_list = [partner , 'simple_notification',{'type':'simple_notification','title': _('Ticket Reminder '+'('+str(ticket.name)+')'),'type': 'warning',  'message': message}]
